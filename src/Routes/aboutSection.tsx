      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 text-lg">
            ...
            businesses succeed in the online world. With a blend of creativity,
            technology, and strategic insight, we specialize in web development,
            app creation, UI/UX design, SEO, email marketing, and more. Our goal
            is simple – to deliver innovative solutions that drive growth,
            improve user experience, and deliver measurable results. Partner
            with us, and let’s bring your digital vision to life.
          </p>
            ...
            <div className="bg-blue-900 text-white p-3 rounded-full">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h3m-3-9a9 9 0 01-9 9M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                />
              </svg>
            </div>
            <div>
              <div className="text-[#1A2B5F] font-semibold">
