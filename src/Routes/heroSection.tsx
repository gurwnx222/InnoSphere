          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full overflow-hidden transform transition-all animate-fadeIn">
            <div className="relative">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-center text-gray-800 mb-2">Enjoying our services?</h3>
                <p className="text-gray-600 text-center mb-6">We value your feedback! Share your experience and help us improve.</p>
                <button
                  onClick={handleReviewClick}
